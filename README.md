...
```sh
fetch https://github.com/llmrb/robert/releases/download/v0.11.0.beta.4/robert
chmod +x robert
```
...
is [v0.11.0.beta.4](https://github.com/llmrb/robert/releases/tag/v0.11.0.beta.4).
